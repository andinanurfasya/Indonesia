...
lyr_2021_1.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'Objectid': 'Objectid', });
lyr_2022_2.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'Objectid': 'Objectid', });
lyr_2023_3.set('fieldAliases', {'PROVINSI': 'PROVINSI', 'Objectid': 'Objectid', });
lyr_2021_1.set('fieldImages', {'PROVINSI': 'TextEdit', 'Objectid': 'TextEdit', });
lyr_2022_2.set('fieldImages', {'PROVINSI': 'TextEdit', 'Objectid': 'TextEdit', });
lyr_2023_3.set('fieldImages', {'PROVINSI': 'TextEdit', 'Objectid': 'TextEdit', });
lyr_2021_1.set('fieldLabels', {'PROVINSI': 'no label', 'Objectid': 'no label', });
lyr_2022_2.set('fieldLabels', {'PROVINSI': 'no label', 'Objectid': 'no label', });
lyr_2023_3.set('fieldLabels', {'PROVINSI': 'no label', 'Objectid': 'no label', });
